...
//                }
//            } else {
//                if (Chats.searchRoom(Users.getCurrentUser().getUsername(), user)== null) {
//                    Chats.makeRoom(Users.getCurrentUser().getUsername(),user);
//                }
//                    Chats.makeChat(tweet.getText(), Users.getCurrentUser().getUsername(), Chats.searchRoom(Users.getCurrentUser().getUsername(), user).getRoomID());
//                    if (tweet.getImage() != null) {
...
//        Users.setProfile(Users.searchUsername(owner));
//        new ChangeScene("../FXML/sample.fxml",anchorPane);
//
//    }
//}
